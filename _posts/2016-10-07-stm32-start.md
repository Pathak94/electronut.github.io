...
One you have decided all of the above, you still have to make a choice on how
...
In *content* you can just choose empty. A the end the dialog, you will end up
...
One you start using any of these files (eg. *stm32f10x_usart.c*) you need
...
To test this, just open any serial communications application on your computer
(I use *CoolTerm*.) and connect at 9600 baud and default settings.
